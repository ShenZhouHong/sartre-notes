...
\noindent
Finally, in some concluding remarks, Sartre talks about shame, fear, and pride in pages \autocite[392 -- 395]{sartre}. He best sums it up by saying: \textcquote[395]{sartre}{Shame, fear, and pride are thereforem y original reactions, they are merely the various ways in which I recognise the Other as a subject out of reach, and they include within themselves an understanding of my ipseity which can and does provide me with the motivation to constitute the Other into an object.}

\section{Chapter 2: The Body}

From now on I will only try to take more high-level and over-arching notes, and refrain from providing such an exhaustive level of quotations.

\subsection{The body as Being-For-Itself: Facticity}

I'm not sure if I understood this section of Sartre's work as well as I could, but it seems like at least for the first part, Sartre is trying to refute the mechanistic and reductionist idea of the body as a being of pure physicality, or biology. My body cannot be reduced to experiences or sensations, but rather it is simply facticity. Now I admit I do not understand this process completely, but it seems persuasive.
