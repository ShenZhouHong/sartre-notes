...
\begin{enumerate}
  \item \textcquote[750]{sartre}{Within the very idea of discovery, of revelation, an idea of the appropriation involved in using something is included. Sight is an \emph{enjoyment} of something; to see something is to \emph{deflower} it.}\footnote{According to the translator, the use of the French verb \emph{jouissance} has strong and unmistakable sexual connotations.}
