\chapter{Part I: The Problem of Nothingness}
...
\begin{enumerate}
  ...
  \item How is it possible for the human consciousness to experience nothingness? The answer to this is \emph{anguish}. \marginnote{The subjective phenomenon of the nothingness (of the self) is \emph{anguish}.}
\end{enumerate}
...
\begin{enumerate}
  ...
  \item After all, the very being of an affirmative answer is defined by its shadow, which is the negative part. When we say that X is Z, we are also simultaneously saying X is not A, B, C, \ldots\ Y. \marginnote{Given every set, we may identify an element within the set both by a positive act of affirmation, and a negative act of excluding everything but the element we wish to identify. There is a strong resemblance to the procedure of the Dedekind cut.}
...
\begin{enumerate}
  ...
  \item \textcquote[40]{sartre}{A being is \emph{fragile} if it bears within its being a clear-cut possibility of non-being.} \marginnote{Are there such things as non-fragile beings? What are they?}
...
\subsection{The Origin of Nothingness}
...
\begin{enumerate}
  ...
  \end{enumerate}
  \item What sort of being is able to nihilate itself? The clue towards this being comes from the ability to \emph{question}. \marginnote{Is there anything unique about the ontology of a question? Does asking a question affect the questioner in any way?} For the act of questioning requires negation, as we have determined earlier already-- but more importantly:
  \begin{enumerate}
...
\begin{enumerate}
  \item \textcquote[66]{sartre}{If nihilating consciousness exists only as a consciousness of nihilation, it ought to be possible to define and describe a constant mode of consciousness, present \emph{as} consciousness, that is the consciousness of nihilation.}
  \begin{enumerate}
    \item This \textbf{consciousness-of-nihilation} is the human emotion of \emph{angst}. \marginnote{It seems like angst is our consciousness of our consciousness of (self) nihilation.}
...
\begin{enumerate}
  \item \textbf{New Working Definition of Consciousness:} \textcquote[87]{sartre}{Consciousness is a being for whom in its being there is consciousness of the nothingness of its being.} \marginnote{Remember! The nothingness of the being of consciousness is where objectivity comes from!}
...
\subsection{The \enquote{Faith} of Bad Faith}
...
\begin{enumerate}
  ...
  \end{enumerate}
  \item \textcquote[117]{sartre}{There is no cynical lie in bad faith, or any knowing preparation of misleading concepts. But \textbf{bad faith's most basic act is to flee from something that is impossible to flee from: to flee from what one is.}}
\end{enumerate}
