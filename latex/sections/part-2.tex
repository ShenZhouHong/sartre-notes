...
\noindent
Now at the start of \autocite[211]{sartre} Sartre begins his presentation on the main body of his argument, \marginnote{How is this continuous motion of \enquote{fleeing} related to the initial \emph{differential} or \emph{pressure} that comes from the lack, and the circuit of ipseity? We are trying to undestand the image of the \enquote{hole constantly being filled.}} which is that dynamic temporality derives its motive force from the process of the being-for-itself fleeing from an in-itself past towards the future. He uses the image of \enquote{a hole constantly being filled}.
