...
\begin{enumerate}
  ...
  \item \textcquote[193]{sartre}{Without the succession of \enquote{others} I could be what I want to be straight away, and there would no longer be any distance between me and myself, or any separation between an action and a dream.}
...
\noindent
Now at the start of \autocite[211]{sartre} Sartre begins his presentation on the main body of his argument, which is that dynamic temporality derives its motive force from the process of the being-for-itself fleeing from an in-itself past towards the future. He uses the image of \enquote{a hole constantly being filled}.
