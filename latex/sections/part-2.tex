...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item "Ultimately, at the infinitisimal instant of my death, I will no longer be anything but my past. It alone will define me." \autocite[174]{sartre}
    \item "Through death, the for-itself [being of consciousness] changes for eternity into in-itself [being of phenomena], to the extent to which it has entirely slipped into the past. Thus the past is the \emph{ever-increasing totality of the in-itself that we are.}" \autocite[174]{sartre}
  \end{enumerate}
